<template>
  <div>
    ...
    <el-row>
      <cdp-operation-region title="账号" :columns="columns" url="/api/v1/account" />
    </el-row>
    <el-row>
      <cdp-table-region v-slot:default="slotProps" title="账号" :columns="columns" url="/api/v1/account">
            ...
            <!-- <el-dropdown-item>
              <el-popover placement="right" width="600" trigger="click">
                <el-form :inline="true" :model="formInline" class="demo-form-inline">
                  ...
                  <el-form-item size="mini">
                    <el-input v-model="formInline.user" placeholder="部门" />
                  </el-form-item>
                  <el-form-item size="mini">
                    <el-input v-model="formInline.user" placeholder="职位" />
                  </el-form-item>
                </el-form>
                <el-table :data="gridData" highlight-current-row>
                  <el-table-column property="name" label="姓名" />
                  <el-table-column property="dept" label="部门" />
                  <el-table-column property="posts" label="职位" />
                  <el-table-column fixed="right" label="操作" width="50">
                    <template slot-scope="scope">
                      <el-button type="text" size="small" @click.native.prevent="bindUser(scope.row, gridData)">
                        绑定
                      </el-button>
                    </template>
                  </el-table-column>
                </el-table>
                <span slot="reference">绑定用户</span>
              </el-popover>
            </el-dropdown-item> -->
